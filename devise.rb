...
def setup_node_bundling
  ...
  # 5. Create the main javascript entrypoint and controllers directory.
  run "mkdir -p app/javascript/controllers"

  # 6. Create the main application.js file to import and initialize everything.
  file "app/javascript/application.js", <<~JS
    // Import and register all your controllers in app/javascript/controllers/index.js
    import "./controllers"

    // The two following lines are required for Turbo Streams to work.
  ...
  # 7. Create a default Stimulus controller.
